...
![install-wizard-1](docs/images/user-guide/install-wizard-1.png)
![install-wizard-2](docs/images/user-guide/install-wizard-2.png)
...
![pet-context-menu-exit-1](docs/images/user-guide/pet-context-menu-exit-1.png)
![pet-context-menu-exit-2](docs/images/user-guide/pet-context-menu-exit-2.png)
...
支持导入动作包，可以在文件选择窗口一次选中多个 zip 文件进行批量导入。
...
- 邮箱: [邮箱地址](elevenlianm@foxmail.com)
